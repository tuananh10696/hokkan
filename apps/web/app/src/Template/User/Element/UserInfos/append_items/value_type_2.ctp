...
?>
        <?= $this->Form->input("info_append_items.{$num}.value_text",['type'=>'text','maxlength' => $length, 'default' => empty($append['value_default'])?'':h($append['value_default']), 'placeholder' => $placeholder]); ?>
